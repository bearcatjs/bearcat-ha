...
var WatcherManager = function(opts) {
    ...
    this.path = this.watchersPath + '/' + HOST_NAME + '-' + PROCESS_PID;
...
WatcherManager.prototype._init = function() {
    var self = this;
    var opts = self.opts;
    this.zk = zookeeper.createClient(opts.zooKeeper);
...
WatcherManager.prototype.startCronJob = function() {
    if (this.isMaster) {
        if (!this.hzJob) {
            this.hzJob = new HZJob();
            this.hzJob.setWatcherManager(this);
        }
